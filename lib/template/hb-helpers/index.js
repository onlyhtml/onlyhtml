...
export function registerHelpers(handlebars) {
    ...
    handlebars.registerHelper(BlockType.COLLECTION, getCollectionHelper(handlebars));
    ...
    handlebars.registerHelper('oh', getDirectiveHelper(handlebars));
    handlebars.registerHelper('local',getLocalDirectiveHelper(handlebars)); // local fields are to be rendered but not sent to the backend 
    ...
    handlebars.registerHelper('pluck', UtilHelpers.pluck);
    handlebars.registerHelper('contains', UtilHelpers.contains);
